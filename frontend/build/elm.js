...
var _user$project$Route$routeToString = function (route) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/#/',
		A2(_elm_lang$core$String$join, '/', routeParts));
};
...
var _user$project$Route$Landing = {ctor: 'Landing'};
var _user$project$Route$NotFound = {ctor: 'NotFound'};
var _user$project$Route$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_user$project$Route$Landing,
			_evancz$url_parser$UrlParser$s('')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Route$NotFound,
				_evancz$url_parser$UrlParser$s('*')),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_user$project$Route$Landing) : A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Route$routeParser, location);
};

var _user$project$Styles_Constants$colors = {tomato: 'FE5D4C', slate: '374F4C', babyPowder: 'FFFEFC'};
var _user$project$Styles_Constants$Colors = F3(
	function (a, b, c) {
		return {tomato: a, slate: b, babyPowder: c};
	});

var _user$project$Styles_Page$namespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('page');
var _user$project$Styles_Page$Link = {ctor: 'Link'};
var _user$project$Styles_Page$Text = {ctor: 'Text'};
var _user$project$Styles_Page$Container = {ctor: 'Container'};
var _user$project$Styles_Page$Backdrop = {ctor: 'Backdrop'};
var _user$project$Styles_Page$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_Page$namespace.name, _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Styles_Page$Backdrop,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$backgroundColor(
					_rtfeldman$elm_css$Css$hex(_user$project$Styles_Constants$colors.babyPowder)),
				_1: {
					ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Styles_Page$Container,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$displayFlex,
					_1: {
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Styles_Page$Text,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$fontSize(
							_rtfeldman$elm_css$Css$vh(3)),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _rtfeldman$elm_css$Css$color(
									_rtfeldman$elm_css$Css$hex(_user$project$Styles_Constants$colors.slate)),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Styles_Page$Link,
						{
							ctor: '::',
...
var _user$project$Styles_Header$namespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('header');
var _user$project$Styles_Header$SubTitle = {ctor: 'SubTitle'};
var _user$project$Styles_Header$Title = {ctor: 'Title'};
var _user$project$Styles_Header$Bar = {ctor: 'Bar'};
var _user$project$Styles_Header$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_Header$namespace.name, _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Styles_Header$Bar,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$backgroundColor(
					_rtfeldman$elm_css$Css$hex(_user$project$Styles_Constants$colors.slate)),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$height(
						_rtfeldman$elm_css$Css$vh(15)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$margin(
							_rtfeldman$elm_css$Css$vh(2)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$displayFlex,
							_1: {
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Styles_Header$Title,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$color(
						_rtfeldman$elm_css$Css$hex(_user$project$Styles_Constants$colors.tomato)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$fontSize(
							_rtfeldman$elm_css$Css$vh(6)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$fontFamilies(
								{
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Styles_Header$SubTitle,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(
							_rtfeldman$elm_css$Css$hex('FE5D4C')),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$fontSize(
								_rtfeldman$elm_css$Css$vh(3)),
...
var _user$project$Views_Header$_p0 = _user$project$Styles_Header$namespace;
var _user$project$Views_Header$class = _user$project$Views_Header$_p0.$class;
var _user$project$Views_Header$view = F2(
	function (title, subTitle) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Views_Header$class(
					{
						ctor: '::',
						_0: _user$project$Styles_Header$Bar,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{
						...
						_0: _user$project$Views_Header$class(
							{
								ctor: '::',
								_0: _user$project$Styles_Header$Title,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					...
					_0: A2(
						_elm_lang$html$Html$span,
						{
							...
							_0: _user$project$Views_Header$class(
								{
									ctor: '::',
									_0: _user$project$Styles_Header$SubTitle,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
...
var _user$project$Styles_List$namespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('list');
var _user$project$Styles_List$Item = {ctor: 'Item'};
var _user$project$Styles_List$Line = {ctor: 'Line'};
var _user$project$Styles_List$Title = {ctor: 'Title'};
var _user$project$Styles_List$Container = {ctor: 'Container'};
var _user$project$Styles_List$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_List$namespace.name, _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Styles_List$Container,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$displayFlex,
				_1: {
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Styles_List$Title,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$fontSize(
						_rtfeldman$elm_css$Css$vh(4)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$fontFamilies(
							{
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Styles_List$Line,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$height(
							_rtfeldman$elm_css$Css$vh(0.5)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(
								_rtfeldman$elm_css$Css$hex(_user$project$Styles_Constants$colors.tomato)),
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Styles_List$Item,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$fontSize(
								_rtfeldman$elm_css$Css$vh(2.5)),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$fontFamilies(
									{
...
var _user$project$Views_List$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Views_List$_p1 = _user$project$Styles_List$namespace;
var _user$project$Views_List$class = _user$project$Views_List$_p1.$class;
var _user$project$Views_List$viewItem = function (value) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _user$project$Views_List$class(
				{
					ctor: '::',
					_0: _user$project$Styles_List$Item,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _user$project$Views_List$viewLink = function (_p2) {
	var _p3 = _p2;
	return A2(
...
var _user$project$Views_List$view = F5(
	function (title, width, renderAsLinks, items, links) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Views_List$class(
					{
						ctor: '::',
						_0: _user$project$Styles_List$Container,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			_elm_lang$core$List$concat(
				{
						...
						_0: A2(
							_elm_lang$html$Html$span,
							{
								...
								_0: _user$project$Views_List$class(
									{
										ctor: '::',
										_0: _user$project$Styles_List$Title,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							...
							_0: A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _user$project$Views_List$class(
										{
											ctor: '::',
											_0: _user$project$Styles_List$Line,
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _user$project$Views_List$styles(
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$width(
													_rtfeldman$elm_css$Css$vw(width)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
					...
					_1: {
						ctor: '::',
						_0: renderAsLinks ? A2(_elm_lang$core$List$map, _user$project$Views_List$viewLink, links) : A2(_elm_lang$core$List$map, _user$project$Views_List$viewItem, items),
						_1: {ctor: '[]'}
					}
				}));
	});
var _user$project$Views_List$viewItems = F3(
	function (title, items, width) {
		return A5(
			_user$project$Views_List$view,
			title,
			width,
			false,
			items,
...
var _user$project$Views_List$viewLinks = F3(
	function (title, links, width) {
		return A5(
			_user$project$Views_List$view,
			title,
			width,
...
var _user$project$Pages_Landing$portfolioInfo = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'Toptal', _1: 'https://www.toptal.com/resume/jared-ramirez'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Github', _1: 'https://github.com/jaredramirez'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Linkedin', _1: 'https://www.linkedin.com/in/jared-ramirez-830591125/'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Pages_Landing$contactInfo = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'jaredramirez@me.com', _1: 'mailto:jaredramirez@me'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '+1 (940) 368 - 7410', _1: ''},
		_1: {ctor: '[]'}
	}
};
var _user$project$Pages_Landing$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Pages_Landing$_p1 = _user$project$Styles_Page$namespace;
var _user$project$Pages_Landing$class = _user$project$Pages_Landing$_p1.$class;
var _user$project$Pages_Landing$view = function (_p2) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Pages_Landing$class(
				{
					ctor: '::',
					_0: _user$project$Styles_Page$Backdrop,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_user$project$Views_Header$view, 'Jared Ramirez', 'Full Stack Dev'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$Pages_Landing$class(
							{
								ctor: '::',
								_0: _user$project$Styles_Page$Container,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Pages_Landing$styles(
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$width(
										_rtfeldman$elm_css$Css$vw(100)),
					...
					{
						ctor: '::',
						_0: A3(_user$project$Views_List$viewLinks, 'Contact', _user$project$Pages_Landing$contactInfo, 40),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Views_List$viewLinks, 'Portfolio', _user$project$Pages_Landing$portfolioInfo, 40),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Views_Arrow$view = A2(
	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fill('#FE5D4C'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$d('M20 3H4v10c0 2.21 1.79 4 4 4h6c2.21 0 4-1.79 4-4v-3h2c1.11 0 2-.89 2-2V5c0-1.11-.89-2-2-2zm0 5h-2V5h2v3zM2 21h18v-2H2v2z'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$Pages_NotFound$quotes = {
	ctor: '::',
	_0: '\"I could spend the rest of my life reading, just satisfying my curiosity\".',
	_1: {
		ctor: '::',
		_0: 'Malcom X',
		_1: {ctor: '[]'}
...
var _user$project$Pages_NotFound$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Pages_NotFound$_p1 = _user$project$Styles_Page$namespace;
var _user$project$Pages_NotFound$class = _user$project$Pages_NotFound$_p1.$class;
var _user$project$Pages_NotFound$view = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Pages_NotFound$class(
			{
				ctor: '::',
				_0: _user$project$Styles_Page$Backdrop,
				_1: {ctor: '[]'}
	...
	{
		ctor: '::',
		_0: A2(_user$project$Views_Header$view, '404 Not Found', ''),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Pages_NotFound$styles(
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$height(
									_rtfeldman$elm_css$Css$vh(50)),
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Route$href(_user$project$Route$Landing),
							_1: {
								ctor: '::',
								_0: _user$project$Pages_NotFound$class(
									{
										...
										_1: {
											ctor: '::',
											_0: _user$project$Styles_Page$Link,
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _user$project$Views_Arrow$view,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$span,
									{
										...
										_0: _user$project$Pages_NotFound$class(
											{
												ctor: '::',
												_0: _user$project$Styles_Page$Text,
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Back to Landing'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						ctor: '::',
						_0: A3(_user$project$Views_List$viewItems, 'uh oh, there\'s nothing here', _user$project$Pages_NotFound$quotes, 55),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
	...
	function (msg, model) {
		...
		if (_p0._0.ctor === 'Just') {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{location: _user$project$Route$NotFound}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Main$view = function (model) {
	...
	if (_p1.ctor === 'Landing') {
		return _user$project$Pages_Landing$view(model.title);
	} else {
		return _user$project$Pages_NotFound$view;
	}
};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {location: a, title: b};
	});
var _user$project$Main$init = function (location) {
	return {
		...
		_0: A2(
			...
			function () {
				var _p2 = _user$project$Route$fromLocation(location);
				if (_p2.ctor === 'Nothing') {
...
var _user$project$Main$RouteChange = function (a) {
	return {ctor: 'RouteChange', _0: a};
};
var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	function (_p3) {
		return _user$project$Main$RouteChange(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Route.Route":{"args":[],"tags":{"NotFound":[],"Landing":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"RouteChange":["Maybe.Maybe Route.Route"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
